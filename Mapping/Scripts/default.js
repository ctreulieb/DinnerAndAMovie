...
// Loads the currently selected pin into the theatre pin global variable in case that theatre is selected
// Adjusts the map to ensure the infobox is not cut off when open
...
// Loads the currently selected pin into the restaurant pin global variable in case that restaurant is selected
// Adjusts the map to ensure the infobox is not cut off on the sides of the map
